...
@section('title', __('Prescriptions List'))
...
@section('content')
            ...
            <div
                ...
                <div class="container mx-auto lg:w-max p-4 lg:p-0">
                    <div
                        ...
                        <a href="{{ route('views.prescriptions.create') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                @include('shared.admin.action', [
                                    ...
                                    'delete' => route('actions.prescriptions.delete', $row->id),
                                ])
                            </td>
                        </tr>
                    @endforeach
    ...
    <section id="page" class="w-full hidden">
        <div class="flex flex-col">
            <h1 class="text-x-black font-x-core text-2xl p-4 leading-[1]">{{ __('Prescriptions List') }}</h1>
