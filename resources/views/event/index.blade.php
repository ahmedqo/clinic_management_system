...
@section('content')
    <div class="flex flex-col gap-4">
        <div class="w-full flex items-center justify-between gap-2">
            <h1 class="font-x-core text-2xl">{{ __('Events List') }}</h1>
            <div
                ...
                <div class="container mx-auto lg:w-max p-4 lg:p-0">
                    <div
                        ...
                        <a href="{{ route('views.events.create') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                @include('shared.admin.action', [
                                    ...
                                    'delete' => route('actions.events.delete', $row->id),
                                ])
                            </td>
                        </tr>
                    @endforeach
    ...
    <section id="page" class="w-full hidden">
        ...
        <div class="flex flex-col">
            <h1 class="text-x-black font-x-core text-2xl mb-4 leading-[1]">{{ __('Events List') }}</h1>
