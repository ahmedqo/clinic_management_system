...
@section('title', __('Update Record') . ' #' . $data->id)

@section('content')
    <div class="flex flex-col gap-4">
        <div class="w-full flex items-center justify-between gap-2">
            <h1 class="font-x-core text-2xl">{{ __('Update Record') }} #{{ $data->id }}</h1>
            <div
                ...
                <div class="container mx-auto lg:w-max p-4 lg:p-0">
                    <div
                        ...
                        <a href="{{ route('actions.contacts.delete', $data->id) }}"
        ...
        <div class="toremove bg-x-white rounded-x-core shadow-x-core p-4">
            <form id="form" action="{{ route('actions.records.update', $data->id) }}" method="POST"
                ...
                <div class="flex flex-col gap-px lg:col-span-6">
                    ...
                    <textarea id="content" name="content" placeholder="{{ __('Content') }}" rows="2"
