...
@section('content')
    <div class="flex flex-col gap-4">
            ...
            <div
                ...
                <div class="container mx-auto lg:w-max p-4 lg:p-0">
                    <div
                        ...
                        <a href="{{ route('views.records.create') }}"
        ...
        <div class="w-full">
            <table x-table search filter remove="5" download="records_list">
                <thead>
                    <tr>
                        <td>#</td>
                        ...
                        <tr>
                            ...
                            <td>
                                @include('shared.admin.action', [
                                    ...
                                    'delete' => route('actions.records.delete', $row->id),
                                ])
                            </td>
                        </tr>
                    @endforeach
    ...
    <section id="page" class="w-full hidden">
        ...
        <div class="flex flex-col">
            <h1 class="text-x-black font-x-core text-2xl mb-4 leading-[1]">{{ __('Records List') }}</h1>
