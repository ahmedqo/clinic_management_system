<header class="w-full bg-x-linear sticky top-0 z-[40]">
    <nav class="w-full flex items-center gap-2 p-2 px-4">
        ...
        <div class="w-max flex items-center gap-1 ms-auto">
            ...
            <div class="w-max relative">
                <button id="settings_trigger" x-toggle targets="#settings"
                    properties="opacity-0, pointer-events-none, translate-y-[40px]"
                    class="p-2 w-[42px] aspect-square flex items-center justify-center rounded-md text-x-white outline-none hover:bg-x-black-blur focus-within:bg-x-black-blur">
                    <svg class="block w-5 h-5 pointer-events-none" fill="currentcolor" viewBox="0 -960 960 960">
                        <path
                ...
                <div id="settings"
                    class="bg-x-black-blur p-2 lg:p-0 flex flex-col justify-end backdrop-blur-sm lg:bg-transparent lg:backdrop-blur-none fixed inset-0 lg:inset-auto lg:w-[160px] lg:absolute lg:right-0 rtl:lg:right-auto rtl:lg:left-0 lg:top-full lg:mt-2 lg:transition-all lg:duration-300 z-50 opacity-0 pointer-events-none translate-y-[40px] ">
                    <div
                        class="shadow-sm lg:shadow-x-drop bg-x-white rounded-md flex flex-col lg:rounded-x-core max-h-[70vh] overflow-hidden border border-x-shade lg:max-h-[300px]">
                        <div class="border-x-shade flex flex-col border-b p-2 gap-2 lg:!hidden">
                            <label
                                class="text-x-black text-base text-center font-black leading-[1] lg:hidden">{{ __('Settings') }}</label>
                        </div>
                        <ul class="flex flex-col">
                            <li class="w-full">
