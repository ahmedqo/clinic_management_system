...
@section('content')
    <div class="flex flex-col gap-4">
        <div class="flex flex-col lg:flex-row gap-4">
            ...
            <div
                class="w-full lg:flex-1 flex-wrap text-x-black bg-x-white rounded-x-core shadow-x-core p-4 flex gap-4 items-center">
                <svg class="pointer-events-none block w-[50px] h-[50px] !text-[var(--color-6)]" fill="currentColor"
                    viewBox="0 -960 960 960">
                    <path
            ...
            <div
                class="w-full lg:flex-1 flex-wrap text-x-black bg-x-white rounded-x-core shadow-x-core p-4 flex gap-4 items-center">
                <svg class="pointer-events-none block w-[50px] h-[50px] !text-[var(--color-9)]" fill="currentColor"
                    viewBox="0 -960 960 960">
                    <path
